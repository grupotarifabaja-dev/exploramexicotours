<?php
/**
 * UI dictionary · English (EN) — doc maestro §10.1.
 * Consumed via emt_t( $key ).
 */
...
return array(
    ...
    'filtros'              => 'Filters',
    'precio'               => 'Price',
    'precio_min_aria'      => 'Minimum price',
    'precio_max_aria'      => 'Maximum price',
    'precio_sin_nota'      => 'Tours without a price are always shown.',
    ...
    'alta'                 => 'Challenging',
    'idiomas'              => 'Languages',
    'punto_salida'         => 'Departure point',
    'incluye'              => 'Included',
    'no_incluye'           => 'Not included',
    'itinerario'           => 'Itinerary',
    'politica_cancelacion' => 'Cancellation policy',
    'salida_garantizada'   => 'Guaranteed departure',
    ...
    'ocup_triple'          => 'Triple',
    'ocup_cuadruple'       => 'Quad',
    'ocup_menor'           => 'Child (6-12)',
    'asientos'             => 'seats',
    'capacidad'            => 'Group size',
    'vehiculo'             => 'Vehicle',
    'consultar'            => 'Inquire',
    ...
    'solicitar_mas_info'   => 'Request more information',
    'fecha_tentativa'      => 'Tentative date',
    'adultos_lbl'          => 'Adults',
    'menores_6_12'         => 'Children (6–12)',
    'total_lbl'            => 'Total',
    'total_estimado_desde' => 'Estimated total from',
    'por_persona_abrev'    => 'p.p.',
    'grupo_cotizamos'      => "For this group size we'll quote you directly on WhatsApp.",
    'menores_por_cotizar'  => 'children quoted separately',
    'wa_disp_intro'        => "Hi, I'd like to check availability for the tour",
    'wa_info_intro'        => "Hi, I'd like more information about the tour",
    'atendido_por'         => 'Referred by',
