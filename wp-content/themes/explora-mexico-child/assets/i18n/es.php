<?php
/**
 * Diccionario de UI · Español (ES) — doc maestro §10.1.
 * Se consume con emt_t( $key ).
 */
...
return array(
    ...
    'filtros'              => 'Filtros',
    'precio'               => 'Precio',
    'precio_min_aria'      => 'Precio mínimo',
    'precio_max_aria'      => 'Precio máximo',
    'precio_sin_nota'      => 'Los tours sin precio siempre se muestran.',
    ...
    'salida_garantizada'   => 'Salida garantizada',
    ...
    'nuestro_equipo'       => 'Nuestro equipo de asesores',
    'blog'                 => 'Blog',
    'contacto'             => 'Contacto',
    'nosotros'             => 'Nosotros',
    'inicio'               => 'Inicio',
    ...
    'solicitar_disponibilidad' => 'Solicitar disponibilidad',
    'solicitar_mas_info'   => 'Solicitar más información',
    'fecha_tentativa'      => 'Fecha tentativa',
    'adultos_lbl'          => 'Adultos',
    'menores_6_12'         => 'Menores (6–12)',
    'total_lbl'            => 'Total',
    'total_estimado_desde' => 'Total estimado desde',
    'por_persona_abrev'    => 'p/p',
    'grupo_cotizamos'      => 'Para este tamaño de grupo te cotizamos directo por WhatsApp.',
    'menores_por_cotizar'  => 'menores por cotizar',
    'wa_disp_intro'        => 'Hola, quiero consultar disponibilidad del tour',
    'wa_info_intro'        => 'Hola, deseo más información sobre el tour',
    ...
    'quitar'               => 'Quitar',
    // Blog (rediseno 2026)
    'blog_sub'             => 'Guias, destinos y tradiciones para inspirar tu proximo viaje.',
    'sigue_leyendo'        => 'Sigue leyendo',
    'min_lectura'          => 'min de lectura',
    'por_autor'            => 'Por',
    'sin_entradas_titulo'  => 'Aun no hay articulos',
    'sin_entradas_texto'   => 'Pronto publicaremos historias y guias de viaje. Vuelve pronto.',
